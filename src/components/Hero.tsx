...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen bg-gradient-to-br from-gray-50 to-indigo-50 dark:from-gray-900 dark:to-indigo-950 transition-colors duration-300 relative overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-16 flex flex-col-reverse lg:flex-row items-center justify-between">
        {/* Left side - text content */}
        <div className="w-full lg:w-1/2 text-center lg:text-left pt-8 lg:pt-0 z-10">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mt-6 sm:mt-12 mb-4 sm:mb-6 text-gray-800 dark:text-white leading-tight">
            Hi, I'm <span className="text-indigo-600 dark:text-indigo-400">Umar Farouk</span>
          </h1>

          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold mb-4 sm:mb-6 text-gray-700 dark:text-gray-200 h-10 sm:h-14 flex items-center justify-center lg:justify-start">
            <span className="text-indigo-600 dark:text-indigo-400">{typedText}</span>
            <span className="animate-pulse ml-1">|</span>
          </h2>

          <p className="text-base sm:text-lg max-w-xl mx-auto lg:mx-0 mb-6 sm:mb-8 text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4 mb-8 sm:mb-12">
            <a
              href="#contact"
              className="px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-lg transition-colors duration-300 shadow-lg hover:shadow-xl flex items-center justify-center"
            >
              Let's Talk
            </a>
            <a
              href="#projects"
              className="px-6 py-3 bg-white dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-800 dark:text-white font-medium rounded-lg border border-gray-300 dark:border-gray-600 transition-colors duration-300 shadow-lg hover:shadow-xl flex items-center justify-center"
            >
              View Projects
            </a>
          </div>
        ...
        <div className="pt-14 w-full lg:w-1/2 flex justify-center relative mb-12 lg:mb-0">
      ...
      <div className="absolute bottom-4 sm:bottom-10 left-1/2 transform -translate-x-1/2 flex flex-col items-center z-10">
        <span className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-1 sm:mb-2">Scroll Down</span>
        <a href="#about" className="animate-bounce">
          <ArrowDown size={20} className="sm:hidden text-indigo-600 dark:text-indigo-400" />
          <ArrowDown size={24} className="hidden sm:block text-indigo-600 dark:text-indigo-400" />
        </a>
      </div>
    </section>
  );
